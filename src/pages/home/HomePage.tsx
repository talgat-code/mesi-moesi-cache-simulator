...
const topologyLines = [
  { coreId: 1, d: 'M290 232 H630 V310', pathId: 'wire-core1-bus' },
  { coreId: 2, d: 'M550 232 H630 V310', pathId: 'wire-core2-bus' },
  { coreId: 3, d: 'M290 642 H630 V560', pathId: 'wire-core3-bus' },
  { coreId: 4, d: 'M550 642 H630 V560', pathId: 'wire-core4-bus' },
]

const packetPaths: Record<string, string> = {
  'core1-bus': 'M290 232 H630 V310',
  'bus-core1': 'M630 310 V232 H290',
  'core2-bus': 'M550 232 H630 V310',
  'bus-core2': 'M630 310 V232 H550',
  'core3-bus': 'M290 642 H630 V560',
  'bus-core3': 'M630 560 V642 H290',
  'core4-bus': 'M550 642 H630 V560',
  'bus-core4': 'M630 560 V642 H550',
  'bus-memory': 'M720 435 H850',
  'memory-bus': 'M850 435 H720',
}
    ...
    <main className="app-shell simulator-page">
      <section className="simulator-shell">
        ...
        <section className="topology-board" aria-label="2D coherence simulation">
          ...
          <svg className="topology-board__wires" viewBox="0 0 1040 820" aria-hidden="true">
            <defs>
              <marker
                id="topology-arrow"
                markerWidth="12"
            ...
            <path d="M630 435 H720" className="topology-wire topology-wire--bus-plate" />
            <path
              d="M720 435 H850"
              className={
                memoryLinkActive
          ...
          <div className="topology-cores">
            {cores.map((core) => (
              ...
              >
                ...
                <div className="core-node__cache-label">Private cache</div>
